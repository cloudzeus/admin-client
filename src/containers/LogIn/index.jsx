...
submit = (values) => {
  ...
  //if no input
  if(values.email.length === 0 || values.email.length === 0 ) return this.setState({
    loading : false,
    loginFailed : true
  })
  ...
  auth.login(values).then( res => {
    console.log('res', res)
    if(res.is_error) return this.setState({ loading : false, loginFailed : true })
  ...
  return ( <div className="account">
    <div className="account__wrapper">
      <div className="account__card">
        ...
        {loginFailed ? <p className="text-danger mb-3 text-center" >incorrect email or password! </p> : null }
        <LogInForm 
